// hooks/scripts/lib/scrub.mjs
// Secret redaction for text that may reach a model, a log, or a banner.
// Port of src/guard/scrub.ts (opencode).
 ...
 * model, written to a log, or placed in a banner. Conservative by design:
